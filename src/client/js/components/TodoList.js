...
import {updateTodoState} from '../actions/todoActions.js';
...
class TodoList extends Component {
  ...
  updateTodoStateHandler(todoItemId) {
    updateTodoState(todoItemId);
  }
        ...
        <div>
          <ul>{(this.props.todos || []).map((data, index) =>
              <TodoItem
                  ...
                  updateTodoStateHandler={this.updateTodoStateHandler}
                  {...data}/>)}
          </ul>
